...
| session_exit_page_title        | STRING      | Title of exit page                                    |
| event_date                 | DATE           | Event date                                                |
| event_datetime             | STRING (ISO)   | Event date and time in ISO format                          |
...
| ecommerce                 | STRING (JSON)  | Ecommerce data serialized as JSON string                   |
| dataLayer                 | STRING (JSON)  | dataLayer payload serialized as JSON string                |
